...
public class Box
{
	...
	{
		return new Box(nbt.getInteger("x1"), nbt.getInteger("y1"), nbt.getInteger("z1"), nbt.getInteger("x2"), nbt.getInteger("y2"), nbt.getInteger("z2"));
	}

	public static NBTTagCompound writeToNBT(Box box)
	{
		NBTTagCompound nbt = new NBTTagCompound();
		nbt.setInteger("x1", box.x1);
		nbt.setInteger("y1", box.y1);
		nbt.setInteger("z1", box.z1);
		nbt.setInteger("x2", box.x2);
		nbt.setInteger("y2", box.y2);
		nbt.setInteger("z2", box.z2);
		return nbt;
	}
