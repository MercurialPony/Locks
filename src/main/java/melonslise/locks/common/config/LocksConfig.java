...
public final class LocksConfig
{
	...
	public static class Server
	{
		...
		public String[] lockableBlocks = { "minecraft:.*chest", "minecraft:dispenser", "minecraft:dropper", "minecraft:hopper",  "minecraft:.*door", "minecraft:.*trapdoor", "minecraft:.*fence_gate" };
		...
		@Config.Ignore
		public Pattern[] lockableBlocksRegex = Arrays.stream(this.lockableBlocks).map(regex -> Pattern.compile(regex)).toArray(Pattern[]::new);
