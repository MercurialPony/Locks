...
public final class LocksScreens
{
	...
	{
		ScreenManager.registerFactory(LocksContainerTypes.LOCK_PICKING, LockPickingScreen::new);
		ScreenManager.registerFactory(LocksContainerTypes.KEY_RING, KeyRingScreen::new);
	}
}